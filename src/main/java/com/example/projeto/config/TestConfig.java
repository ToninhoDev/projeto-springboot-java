...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Poduct p1 = new Poduct(null, "The Lord of the Rings", "Lorem ipsum dolor sit amet, consectetur.", 90.5, "");
		Poduct p2 = new Poduct(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas ante.", 2190.0, "");
		Poduct p3 = new Poduct(null, "Macbook Pro", "Nam eleifend maximus tortor, at mollis.", 1250.0, "");
		Poduct p4 = new Poduct(null, "PC Gamer", "Donec aliquet odio ac rhoncus cursus.", 1200.0, "");
		Poduct p5 = new Poduct(null, "Rails for Dummies", "Cras fringilla convallis sem vel faucibus.", 100.99, "");
		...
		User u3 = new User(null, "Toninho", "Toninho@gmail.com", "88888888", "123456");
